...
const CoursesHome = () => {
  return (
    <div className='flex justify-center'>
          <div className='text-7xl pt-3 xl:text-7xl lg:text-5xl md:text-4xl text-2xl text-white xl:w-8/12 lg:w-9/12 md:w-10/12 w-11/12  font-header12 flex flex-col justify-center ' >
