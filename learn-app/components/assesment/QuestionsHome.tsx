...
const QuestionsHome = () => {
  const {isCreateQuestionsOpen, setisCreateQuestionsOpen, QuestionsArray,setisQuestionList,  setisQuestionHome} = React.useContext(AssesmentContext) as Iassesmentcontext
...
<motion.div exit={{
  ...
  // opacity:0
    ...
    <div onClick={()=>{
      ...
      {QuestionsArray.length?`Explore Questions Created [!]`:'No Questisons Created yet '}
       ,<span className='font-header6' ></span>
      </div>
      <div style={{
