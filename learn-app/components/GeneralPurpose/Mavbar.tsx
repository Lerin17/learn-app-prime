...
const Mavbar = () => {
  return (
        ...
        <div className='relative xl:w-8/12 lg:w-9/12 w-11/12' >
                <div
                style={{opacity:'20%'}}
                className=' text-xl flex justify-between px-3  rounded   absolute w-full py-1  z-10 text-2xl text-transparent nylon2'>
                      [c]
                </div>
                <div 
                style={{
                ...
                className='text-xl flex justify-between px-3 py-1 rounded  font-header9 text-gray-900'>
