...
<div 
                ...
                className='text-lg flex   justify-between px-3 py-1   font-header10 text-gray-300 z-30 bg-transparent rounded-full shadow absolute w-full'>
                ...
                <svg className='fill-current text-gray-300' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M23 20.168l-8.185-8.187 8.185-8.174-2.832-2.807-8.182 8.179-8.176-8.179-2.81 2.81 8.186 8.196-8.186 8.184 2.81 2.81 8.203-8.192 8.18 8.192z"/></svg>
                  ...
                  handleClick={()=>{
                    ...
                    setisCreateQuestionsOpen(prev => !prev)
                  }}
                  color='gray'
                  />
                ...
                <div
                style={{opacity:'30%'}}
                className=' text-xl flex justify-between px-3  rounded-full   absolute w-full py-1 nylon z-20 text-2xl text-transparent'> 
                      {/* [c] */}[c]
                </div>
                ...
                <div
                style={{opacity:'100'}}
                className=' text-xl flex justify-between px-3  rounded-full   relative w-full py-1  z-10 text-2xl text-transparent vortex'> 
                      {/* [c] */}[c]
                </div>
