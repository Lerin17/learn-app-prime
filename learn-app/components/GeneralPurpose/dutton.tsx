...
const DuttonAlt = (props:duttonProps) => {
  return (
    ...
    >
     ...
     className='flex text-center text-stone-300 items-center font-header9 lg:text-2xl md:text-xl text-xs hover:bg-stone-300  py-1  text-gray-300  px-1 cursor-pointer font-header12 hover:text-stone-800 transition-all'>
